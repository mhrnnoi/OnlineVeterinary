...
{
    public class GetDoctorByEmailQueryHandler : IRequestHandler<GetDoctorByEmailQuery, ErrorOr<Doctor>>
    {
        ...
        public async Task<ErrorOr<Doctor>> Handle(GetDoctorByEmailQuery request, CancellationToken cancellationToken)
        {
