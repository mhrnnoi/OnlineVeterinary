...
{
    public class DeleteDoctorByIdCommandHandler : IRequestHandler<DeleteDoctorByIdCommand, string>
    {
        ...
        public async Task<string> Handle(DeleteDoctorByIdCommand request, CancellationToken cancellationToken)
        {
