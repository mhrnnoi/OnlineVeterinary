...
namespace OnlineVeterinary.Application.UnitTests.Auth.Commands
{
    public class ChangePasswordHandlerTests
    {
        ...
        public async Task Handle_Should_ReturnNotFound_WhenUserIsNullAsync()
        {
            //Arrange
            var id = Guid.NewGuid();
            var command = new ChangePasswordCommand(id.ToString(), "mehrn@email.com");
            var handler = new ChangePasswordCommandHandler(_userRepositoryMock.Object, _mapperMock.Object, _unitOfWorkMock.Object);
